...
<div class="col-md-6">
    ...
    <div class="form-group ">
        ...
        <div class="col-md-6">
            ...
            <option value="">- select date -</option>
                    <?php  $dates = App\Dates::where('active',1)->get(); ?>
                    @foreach( $dates as $d)
    ...
    <div class="form-group ">
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <?php $requesters = App\Group::where('active', 1)->whereIn('parent', ['SSD', 'SCC'] )->orderBy('name')->get() ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <?php $Groups = App\Group::where('active', 1)->whereIn('parent', ['SSD', 'SCC'] )->orderBy('name')->get() ?>
    ...
    <div class="form-group ">
        ...
        <div class="col-md-6">
            ...
            <?php $customers = App\Ticket::select('customer')->whereNotNull('customer')->orderBy('customer')->groupBy('customer')->get() ?>
    ...
    <div class="form-group ">
        ...
        <div class="col-md-6">
            ...
            <?php $users = App\User::select('*')->orderBy('first_name')->get() ?>
            <option value="">- select -</option>
