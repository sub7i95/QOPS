    ...
    <input type="hidden" name="ticket_id" id="ticket_id" value="{{ $ticket->id }}" >
      ...
      <div class="modal-body">
        ...
        <table id="table_activity" class="table table-striped table-bordered table-hover table-checkable order-column" >
            ...
            <?php $activities = App\TicketActivity::where('ref_number', $ticket->ref_number )->get() ?>
              ...
              <tr>
                ...
                <td> 
                      <select name="score[]" id="score"  class="form-control input-sm">
                        <option value="-1"  <?php if( $activity->score==-1 ) echo 'selected' ?> >N/A</option>
                        <option value="0"   <?php if( $activity->score==0 )  echo 'selected'  ?> >No</option>
                        <option value="1"   <?php if( $activity->score==1 )   echo 'selected' ?> >Yes</option>                                         
                      </select>
                </td>
